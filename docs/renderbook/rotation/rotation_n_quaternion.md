...
Then _P'_ = [0，_p'_] = _q_ **P** _q^-1_ = _q_ **P** _q*_ where _p'_ is the rotated point

= [_cos θ/2_, _normalized u_ __sin θ/2_]_ [0, _p_] _[_cos θ/2_, - _normalized u__ _sin θ/2_]
