# Minecraft 1.12.2 Renderbook

This section aims to serve as a tutorial for Minecraft 1.12.2 rendering, _**but**_
...
- [Font Renderer & Basic GL Calls](state/fontrenderer_basic_gl_calls.md)
- [Common GL States](state/gl_states.md)
- [Shape & State Experiments](state/shapes_n_states.md)

## Rotation

- [Rotation & Quaternion](rotation/rotation_n_quaternion.md)

## Alpha & Blending

- [Alpha Testing Explained](alpha_blend/alpha_test.md)
- [Blending Explained](alpha_blend/blend.md)

## Stencil

- [Stencil Experiments](stencil/stencil.md)
...
- [Drawing A 3D Object Via The Fixed-Func Pipeline](common/fixed_func_3d_shapes.md)
...
- [Drawing Tris Using Vertices and Indices Via The Modern Pipeline](prog_pipe/draw_vertices.md)
- [Shader Loading & Shader Program](prog_pipe/shaders.md)
- [VAO & Vertex Format](prog_pipe/vao_n_vertex_format.md)
- [Common Buffer Objects](prog_pipe/buffer_objects.md)
- [Typical Shader Setup](prog_pipe/typical_shader_setup.md)

## NIO ByteBuffer

- [NIO ByteBuffer Tips](bytebuffer/nio_bytebuffer.md)

## GL States Related Concerns

Here are some major [Concerns](state/concerns.md)

## GL Execution Model

1. [Command Data Flow](gl_basics/command_data_flow.md)
2. [Command Order](gl_basics/order.md)
3. [Common Synchronizations](gl_basics/synchronization.md)
...
- [Common Hazards](hazard/raw_war.md)
...
[JUnit OpenGL Extension](unit_test/junit_gl_extension.md)
